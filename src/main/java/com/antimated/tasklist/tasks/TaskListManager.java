...
public class TaskListManager
{
	...
	public void onGameTick(GameTick gameTick)
	{
		...
		if (loginFlag)
		{
			...
			{
				log.debug("Satisfying tasks: {}", list.getTasksByCompletion(false).getTasksByTier(TaskTier.MASTER).getSatisfyingTasks(client));
				log.debug("{} has a total of {} tasks with tasks {}", list.getName(), list.getTasks().size(), list.getTasks());
			}
...
//	{
//		TaskList tasks = new TaskList("Global task list");
//
//		// Any level tasks
